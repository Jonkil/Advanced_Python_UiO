...
def test_color2gray(image):
    """Check that grayscale filter works in numpy implementation."""
    gray_image = numpy_color2gray(image=image)
...
def test_color2sepia(image, reference_sepia):
    """Check that sepia filter works in numpy implementation."""
    sepia_image = numpy_color2sepia(image=image)
